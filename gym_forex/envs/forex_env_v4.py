...
#TODO: PROBAR CON 4 ACCIONES: 0=NOP,1=BUY, -1=SELL, CLOSE
    ...
    def step(self, action):
       ...
       # self.episode_over = bool(0)
        ...
        info = {"action":action,"observation":ob, "episode_over":self.episode_over,"balance":self.balance, 
                "tick_count":self.tick_count, "num_closes":self.num_closes, "equity":self.equity, 
                "reward":self.reward, "order_status":self.order_status, "margin":self.margin, 
                "initial_capital":self.initial_capital, "MoY": MoY, "DoM": DoM, "HoD": HoD,"MoH":MoH}
